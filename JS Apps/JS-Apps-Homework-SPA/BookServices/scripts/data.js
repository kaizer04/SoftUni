...
app.data = (function () {
    ...
    var Bookmarks = (function (baseUrl, ajaxRequester) {
        ...
        Bookmarks.prototype.edit = function (objectId, bookmark) {
            var url = this._serviceUrl + '/' + objectId;
            return this._ajaxRequester.put(url, bookmark, this._headers);
        }
